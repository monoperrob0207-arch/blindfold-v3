...
const INITIAL_AGENTS: Agent[] = [
  {
    ...
    status: 'active',
    color: '#ff3366',
    capabilities: ['promaxui', 'superui', 'workflow', 'components'],
    suggestionCount: 12,
  ...
  },
  {
    ...
    status: 'active',
    color: '#00d4ff',
    capabilities: ['css_glass', 'react_glass', 'webgl', 'liquidgl'],
    suggestionCount: 8,
  ...
  },
  {
    ...
    status: 'active',
    color: '#10b981',
    capabilities: ['code_generate', 'refactor', 'debug'],
    suggestionCount: 45,
  ...
  },
  {
    ...
    status: 'idle',
    color: '#06b6d4',
    capabilities: ['data_analysis', 'kpi_calculation'],
    suggestionCount: 34,
